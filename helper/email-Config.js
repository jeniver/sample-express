...
const  eventEmails = ()  => {
const CLIENT_ID = '918661905673-5lhp8pmata5u7v6onukb5quocg1ber7c.apps.googleusercontent.com';
const CLEINT_SECRET = 'gDbFl4DMHqZ5xLup2wQllX6J';
const REDIRECT_URI = 'https://developers.google.com/oauthplayground';
const REFRESH_TOKEN = '1//04qmMUgMlhKocCgYIARAAGAQSNwF-L9IrHvCpY1yo0c-lNoQ-XQ4y7SP4dA7Md5YD5cg5pDmB8DqbYXDYquW4Qa8I4ElSVOw279o';
...
<p style="margin: 0; font-size: 14px; line-height: 1.8; word-break: break-word; text-align: left; mso-line-height-alt: 25px; margin-top: 0; margin-bottom: 0;"><span style="color: #2a272b;"><strong>Digital Events NYC</strong></span></p>
</div>
</div>
...
<p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;"><span style="color: #004afd;"><strong>Biggest Event of the Year</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div class="txtTinyMce-wrapper" style="line-height: 1.2; font-size: 12px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 14px;">
<p style="margin: 0; font-size: 42px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 50px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 42px; color: #2a272b;"><strong>Thank you for reserving your spot!</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="margin: 0; line-height: 1.5; word-break: break-word; text-align: center; font-size: 16px; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 16px; color: #2a272b;">Nulla maximus est nec dictum imperdiet. Nulla sit amet purus lectus. Maecesit amet ante eu lorem eleifend condi mentum. Maecenas diam eros, vulputate eu tin idunt id, ornare at purus. Nunc pretium, lectus at nar iaculis, sem leo vehicula.</span></p>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:45pt;width:162pt;v-text-anchor:middle;" arcsize="100%" stroke="false" fillcolor="#004afd"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center autowidth" src="images/reminder-hero-graph.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 640px; max-width: 100%; display: block;" title="Image" width="640"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="left"><![endif]--><img alt="I'm an image" border="0" class="left autowidth" src="images/Logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 154px; max-width: 100%; display: block;" title="I'm an image" width="154"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 12px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 18px;">
<p style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">Copyright © 2020</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
async function sendMail() {
  try {
    ...
    const transport = nodemailer.createTransport({
      ...
      auth: {
        type: 'OAuth2',
        user: 'omsaravanabavababaji@gmail.com',
        clientId: CLIENT_ID,
    ...
    var maillist = [
        'wpanduka314@gmail.com ',
        'shanindu.rajapaksha91@gmail.com',
        'geniverjoy96@gmail.com',
        'jooyjen@gmail.com'
      ];
    const mailOptions = {
      from: 'Hello <omsaravanabavababaji@gmail.com>',
      to: maillist,
